...
`)],-1),k=a("",1),c=a("",1),g=t("pre",null,[t("code",null,`.dataframe tbody tr th {
    vertical-align: top;
}
...
`)],-1),_=a("",1),y=a("",6),u=t("pre",null,[t("code",null,`.dataframe tbody tr th {
    vertical-align: top;
}
